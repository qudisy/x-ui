...
config_after_install() {
    ...
    read -p "Confirmation of continuation?[y/n]": config_confirm
...
install_x-ui() {
    ...
    if [ $# == 0 ]; then
        ...
        echo -e "Start installation of x-ui v$1"
    ...
    wget --no-check-certificate -O /usr/bin/x-ui https://raw.githubusercontent.com/qudisy/x-ui/main/x-ui.sh
